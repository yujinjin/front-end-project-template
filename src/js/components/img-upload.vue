...
// 是否显示裁剪弹窗
const isShowCropperDialog = ref(false);

const updloadRef = ref(null);
...
// 图片上传API
const imageUploadApi = async function (file) {
    const img = await commonAPI.uploadImage({ file });
...
const defaultUploadProps = {
    ...
    listType: "picture",
    onRemove: function (uploadFile, uploadFiles) {
