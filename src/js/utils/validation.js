 ...
 * @创建时间: 2022-10-21 11:17:25
 * @最后修改作者: yujinjin9@126.com
 * @最后修改时间: 2022-10-21 11:21:25
 * @项目的路径: \360-manager-H5\src\js\utils\validation.js
 * @描述: 常用验证工具类方法
 */

// 中国手机号码验证
export function chinaPhoneNumberValidate(phoneNumber) {
...
// 中国身份证验证（支持香港、澳门、台湾）
export function chinaIDCardValidate(IDCard) {
